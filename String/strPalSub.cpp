...
Given a String S1 and String S2. Convert string S1 to a palindrome string such S2 is a substring of 
that palindromic string. Only operation allowed on S1 is replacement of any character with any other
character. Find minimum number of operations required.
*/
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    int ans = INT_MAX;
    if (l2 > l1) //for being a substring l2 must be smaller
    {
